...
<div class="col2">
**Global assessment scores 2012-2018**

Quick access to *.csv* files of calculated global scores.

- [Download by clicking here](https://raw.githubusercontent.com/OHI-Science/ohi-global/published/global2018/OHI_final_formatted_scores_2018-11-28.csv), then right-click to Save As.
- [View the metadata](https://github.com/OHI-Science/ohi-global/tree/published/global2018#ohi-2018-global-metadata).

**Documentation and Instruction**

- [2018 Global OHI Scores Report](https://raw.githack.com/OHI-Science/ohi-global/published/global2018/Results/Supplement_Results.html) 
- [2018 Methods](https://raw.githack.com/OHI-Science/ohi-global/published/global_supplement/Supplement.html)
...
- [data preparation releases (`ohiprep` repository)](https://github.com/OHI-Science/ohiprep_v2018/releases) 
...
We thank all the groups that collect and share data openly; please see the [global layers page](https://github.com/OHI-Science/ohi-global/layers.html) for a full list. We also thank developers and communities that make and teach free software tools, in particular [R](https://cran.r-project.org/), [RStudio](https://www.rstudio.com), [git](https://git-scm.com/), [GitHub](https://github.com/), and [rOpenSci](https://ropensci.org/).
