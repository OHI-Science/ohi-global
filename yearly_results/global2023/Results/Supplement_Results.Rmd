...
### See ohi-global/yearly_results/global2023/Results_first_look.Rmd 
...
A CSV formatted dataset from the 2023 assessment is [available](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/yearly_results/global2023/OHI_final_formatted_scores_2023-09-15.csv), right click on data and select "Save as...". These data include index and goal/subgoal scores (as well as the dimensions used to calculate scores: status, trend, pressure, resilience) for all `r 2023 - 2011` assessment years (2012-2023). See [README](https://github.com/OHI-Science/ohi-global/tree/draft/yearly_results/global2023) for description of data.

The data layers (described in section 7 in Methods) and functions used to calculate scores can be downloaded from Github: [ohi-global v2023.1: Global scenarios data for Ocean Health Index](https://github.com/OHI-Science/ohi-global/releases).  

The files used to prepare data layers for the ohi-global assessment can be downloaded from Github: [ohiprep v2023.1: Preparation of data for 2023 Ocean Health Index global assessment](https://github.com/OHI-Science/ohiprep_v2023/releases).
...
##### Figure A. Regional 2023 OHI index scores.
...
##### Figure B. Flowerplot of 2023 goal/subgoal scores
...
##### Figure C. Maps and histograms of 2023 OHI goal scores.
...
##### Figure D. Maps and histograms of 2023 OHI subgoal scores.
...
Overview of the scores from the 2023 assessment. Each row represents a region, the main groupings represent goals, and within each goal there are `r 2023 - 2011` years of data. Black regions indicate no data. Download the [png version](https://github.com/OHI-Science/ohi-global/raw/draft/yearly_results/global2023/Results/figures/carpetPlot.png) to zoom in to see specific regions.
