...
###### update this 2024!######
dateFile       <- "2023-10-02" # date extension on data files used for all tables/figures
benchmark_date <- "2022-10-05" # Date from last assessment
```
...
###### update this 2024!######
[These data](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/yearly_results/global2023/OHI_final_formatted_scores_2022-10-02.csv) are the OHI scores for the eez regions of 220 countries and territories from 2012 to 2023.
...
###### update this 2024!######
Country index scores for 2023  Maps describing goal and index scores can be downloaded from [here](https://github.com/OHI-Science/ohi-global/tree/draft/yearly_results/global2032/Results/figures/maps_by_goal_mol).
...
###### update this 2024!######
Carpet plot figure ([download as high resolution png](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/yearly_results/global2023/Results/figures/carpetPlot.png)) providing an overview of the scores from the 2023 assessment.  Each row represents a region, the main groupings represent goals, and within each goal there are 12 years of data. Black regions indicate no data.
...
###### update this 2024!######
This interactive table describes the index and goal scores for the regions in 2024 (or, [download csv version](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/yearly_results/global2023/Results/data/scores_eez_2023.csv)): 
...
###### update this 2024!######
A color-coded table of trend values for each country is available [here](https://rawgit.com/OHI-Science/ohi-global/draft/yearly_results/global2023/Results/data/trends_2023.html) (as well as a [csv file](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/yearly_results/global2023/Results/data/trends_2023.csv)).  
...
This section takes a closer look at the goal/subgoal scores for the 2023 scenario.
...
The following is a comparison of the global status scores generated for the 2023 scenario by this year's assessment vs. last year's assessment. 
...
data_compare <- data_compare %>%
  dplyr::arrange(goal) %>%
  dplyr::mutate(change = assess2023 - assess2022)
...
The following interactive plot provides an overview of how the 2023 scenario scores changed between the 2022 and 2023 assessments for all goals and dimensions.
