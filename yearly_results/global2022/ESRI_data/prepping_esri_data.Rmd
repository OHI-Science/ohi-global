...
setwd(here("yearly_results/global2021/ESRI_data"))
```
...
```{r}
scores_2021 <- read_csv(file.path("../scores_2021-11-17.csv")) %>% ## change this to your new assessment years score csv
...
scores_2021_sf_names <- scores_2021 %>%
...
st_write(scores_2021_sf_names, "scores_2021/scores_2021_names.shp", driver="ESRI Shapefile")

# scores_2020_shp_names <- as_Spatial(scores_2020_sf_names)
mapview(scores_2021_sf_names)

scores_2021_sf_no_names <- scores_2021_sf_names %>%
...
st_write(scores_2021_sf_no_names, "scores_2021/ohi_scores_2020_final.shp", driver="ESRI Shapefile") ## always keep 2020 in the name... see instructions above.

mapview(scores_2021_sf_no_names)
```
