...
## This set of function can be updated and simplified to use geom_sf which was not an option when first written
## Reccomended use of terra::vect() and the tidyterra package to plot
source(here::here(dir_results_functions, "map_fxns.R"))

### set desired map projection
...
# This builds the entire goals section
