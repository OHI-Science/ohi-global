...
spp_trend <- scores %>%
  filter(goal == "SPP", dimension == "trend", region_id != 0, scenario == 2022)
...
# ok so Libya and Syria have the biggest decrease in score (-6) from 2012 to 2021.. lets look into this

data_lib_cyp <- data %>%
  filter(region_name %in% c("Libya", "Syria"))
