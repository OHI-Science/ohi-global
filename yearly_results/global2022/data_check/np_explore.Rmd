...
```{r}
scores <- read_csv(file.path(here(), "yearly_results/global2022/OHI_final_formatted_scores_2022-10-05.csv"))
...
fofm_scores <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2022/gh-pages/globalprep/np/v2022/output/np_fofm_scores.csv')
...
sw_sust <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2022/gh-pages/globalprep/np/v2022/output/np_seaweed_sust.csv')

chn_sw_sust <- sw_sust %>%
  filter(rgn_id == 209) ## doesnt seem like there is a sw score here 

sw_prod <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2022/gh-pages/globalprep/np/v2022/output/np_seaweed_harvest_tonnes.csv')
...
prod_weights <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2022/gh-pages/globalprep/np/v2022/output/np_product_weights.csv')
