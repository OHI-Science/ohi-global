...
dateFile = "2022-08-25" # date extension on data files used for all tables/figures
...
saveFile <- paste0('global', scenario) # location where files that are created are to be saved
...
for(year in 2012:scenario){ 
  ...
  data_final <- rbind(index, data) %>%
    select(region_name, region_id, Index, AO, SPP, 
           BD, HAB, CP, CS, CW, ECO, LE, LIV, FIS, FP, 
           MAR, ICO, SP, LSP, NP, TR)
  
  write.csv(data_final, 
            here(sprintf("yearly_results/%s/Results/data/scores_eez%s.csv", saveFile, year)), 
            row.names = FALSE, na='')
}
```
...
knitr::include_graphics(
  here(
    sprintf("yearly_results/%s/Results/figures/FlowerPlots/flower_GlobalAverage.png", saveFile)
    )
  )
```
...
source(here("yearly_results", paste0("global", scenario), "Results", "functions", "map_fxns.R"))
...
colors <- c(reds, blues)
#write_csv(data.frame(colors), here("yearly_results/global2022/Results/color_palette.csv")) # do we comment this out for knitting? 
...
## save a version of 2022 maps without legend
year = scenario
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_Index_%s_mol.png", saveFile, scenario)))
...
hist_data_old <- read_csv(here("yearly_results/global2021/Results/data/scores_eez2021.csv")) %>%
  select(region_name, Index)
...
This interactive table describes the index and goal scores for the regions in 2022 (or, [download csv version](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/yearly_results/global2022/Results/data/scores_eez2022.csv)): 
...
knitr::kable(trends_order[(bottom-9):bottom, ])
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_AO_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_SPP_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_HAB_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_CP_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_CS_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_CW_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_FIS_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_MAR_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_ICO_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_LSP_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_NP_2022_mol.png", saveFile)))
...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_TR_2022_mol.png", saveFile)))
...
data <- read.csv(here(sprintf("yearly_results/%s/OHI_final_formatted_scores_%s.csv", saveFile, dateFile)), stringsAsFactors = FALSE) %>%
  rename("assess2022"=value) 

data_old <- read.csv(here(sprintf('yearly_results/global%s/OHI_final_formatted_scores_2021-11-17.csv', benchmark)), stringsAsFactors = FALSE) %>%
...
data_compare <- data_compare %>%
  arrange(goal) %>%
  mutate(change = assess2022 - assess2021)
