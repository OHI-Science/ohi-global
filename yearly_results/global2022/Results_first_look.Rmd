...
```{r Map scores, eval=map_create, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE}
...
```{r trend_maps, eval=map_create, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE}
