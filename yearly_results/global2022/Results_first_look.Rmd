...
knitr::include_graphics(here(sprintf("yearly_results/%s/Results/figures/maps_by_goal_mol/global_map_Index_2022_mol.png", saveFile)))
...
data_old <- read.csv(here(sprintf('yearly_results/global%s/OHI_final_formatted_scores_2021-10-01.csv', benchmark)), stringsAsFactors = FALSE) %>%
