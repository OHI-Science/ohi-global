...
dateFile = '2019-08-14' #date extension on data files used for all tables/figures
...
Flower plots for each region can be downloaded from [here](https://github.com/OHI-Science/ohi-global/yearly_results/global2019/Results/figures/FlowerPlots)
...
eez_spread <- trends_spread %>%
  arrange(-Index) %>%
  filter(country != 'eez_weighted_avg')
# sum(trends_spread$Index>0) # 110
# sum(trends_spread$Index<0) # 110 # weird that these are exactly equal? weren't that way in v2018
...
A color-coded table of trend values for each country is available [here](https://rawgit.com/OHI-Science/ohi-global/yearly_results/global2019/Results/data/trends_2019.html) (as well as a [csv file](https://raw.githubusercontent.com/OHI-Science/ohi-global/yearly_results/global2019/Results/data/trends_2019.csv)).  
...
![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_Index_mol.png) 
...
![]here(yearly_results/global2019/Results/figures/Trend_barplot.png) 
...
# v2019: getting some error messages here about missing values and non-finite values being removed
```

## Artisanal opportunities

### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_AO_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/AO_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_SPP_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/SPP_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_HAB_2018_mol.png)


![]here(yearly_results/global2019/Results/figures/goal_histograms/HAB_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_CP_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/CP_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_CS_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/CS_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_CW_2018_mol.png)


![]here(yearly_results/global2019/Results/figures/goal_histograms/CW_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_FIS_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/FIS_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_MAR_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/MAR_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_ICO_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/ICO_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_LSP_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/LSP_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_NP_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/NP_scores.png)
...
### Scores
![]here(yearly_results/global2019/Results/figures/maps_by_goal_mol/global_map_TR_2018_mol.png)

![]here(yearly_results/global2019/Results/figures/goal_histograms/TR_scores.png)
...
![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_AO_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_SPP_mol.png)


![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_HAB_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_CP_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_CS_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_CW_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_FIS_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_MAR_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_ICO_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_LSP_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_NP_mol.png)

![]here(yearly_results/global2019/Results/figures/map_trends/trends_map_TR_mol.png)
