...
This document describes results from the OHI 2019 global assessment.  This is mostly an internal document to explore and check results.  It also creates the figures used on the website and in other documents.
...
dateFile = '2019-08-12' #date extension on data files used for all tables/figures
...
![](here(yearly_results/global2019/Results/figures/FlowerPlots/flower_GlobalAverage.png)) 
...
source(here("yearly_results/global2016/Reporting/map_fxns.R")) # OK to keep sourcing 2016 files?
