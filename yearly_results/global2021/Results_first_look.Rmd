...
dateFile = '2021-11-17' #date extension on data files used for all tables/figures
...
PlotFlower(
  region_plot = NA,
  dir_fig_save = here(sprintf("yearly_results/%s/Results/figures/FlowerPlots_v2_title", saveFile)),
  assessment_name = "Global Average",
  year_plot = 2021,
  scores_file = here(sprintf("yearly_results/%s/scores_%s.csv", saveFile, dateFile)),
  scenario_folder = "eez"
