...
lsp_scores <- read_csv(file.path(here(), "yearly_results/global2021/scores_2021-11-04.csv"))

lsp_scores <- read_csv(file.path(here(), "yearly_results/global2021/OHI_final_formatted_scores_2021-11-04.csv"))
