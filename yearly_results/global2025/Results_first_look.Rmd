...
###### update this 2024!######
dateFile       <- "2025-12-03" # date extension on data files used for all tables/figures
...
[These data](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/yearly_results/global2025/OHI_final_formatted_scores_2025-12-03.csv) are the OHI scores for the eez regions of 220 countries and territories from 2012 to 2025.
...
This interactive table describes the gross change in index and goal scores for the regions between 2012 and 2025. This is helpful in investigating a single country by searching the region name and seeing how much each goal value has changed overall from the first year to the last.  
...
trends_wide <- rbind(index, eez_wide) %>%
 dplyr::select(country, region_id, goals[goals != "ECO"]) %>% 
...
for(goal in goals[names(goals) != "ECO"]){ #goal="CW"
