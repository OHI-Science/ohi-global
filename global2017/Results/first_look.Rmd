...
dateFile = '2017-11-15' #date extension on data files used for all tables/figures


### code to run (change these if data is updated, otherwise takes a while to run):
update_data = TRUE           # This will update the dataset used to create figures/tables
