...
ao_access <- read.csv('global2015/gapFilling/layers/ao_access.csv')

data <- rbind(data, data.frame(layer = "AO access",
                               proportion_gf = mean(ao_access$value)))

ao_need <- read.csv('global2015/gapFilling/layers/ao_need.csv')
...
# harvest data
harvest <- read.csv('global2015/gapFilling/layers/np_harvest_tonnes_relative.csv') %>%
...
# fish scores
fish <- read.csv('global2015/gapFilling/scores.csv') %>%
...
## condition
condition_gf <- read.csv('global2015/gapFilling/layers/hab_health.csv') %>%
...
condition_gf <- read.csv('global2015/gapFilling/layers/hab_health.csv') %>%
  ...
  mutate(layer = paste0(habitat, ": condition")) %>%
  select(layer, proportion_gf) %>%
  mutate(componet = "goal") %>%
  data.frame()

data <- rbind(data, condition_gf)

## trend
trend_gf <-  read.csv('global2015/gapFilling/layers/hab_trend.csv') %>%
...
### TR ----
tr_sus <-  read.csv('global2015/gapFilling/layers/tr_sustainability.csv')
...
# nutrient/fertilizer
fert <- read.csv('global2015/gapFilling/layers/po_nutrients_3nm.csv')
...
pathogen <- read.csv('global2015/gapFilling/layers/po_pathogens.csv') %>%
...
## trash
trash <- read.csv('global2015/gapFilling/layers/po_trash.csv')
data <- rbind(data, data.frame(layer = "trash",
                               proportion_gf = mean(trash$pressure_score),
                               component = "goal"))

## coastal population
population <- read.csv('global2015/gapFilling/layers/mar_coastalpopn_inland25mi.csv') %>%
  filter(year==max(year))
...
target <- read.csv('global2015/gapFilling/layers/fp_targetharvest.csv')
...
wgi <- read.csv('global2015/gapFilling/layers/wgi_all.csv')
