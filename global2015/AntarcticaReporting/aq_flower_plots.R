...
conf <-  read.csv(sprintf("antarctica%s/conf/goals.csv", scenario), stringsAsFactors=FALSE) 
...
data <- read.csv(sprintf('antarctica%s/scores.csv', scenario), stringsAsFactors=FALSE) 
