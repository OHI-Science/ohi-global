...
antarctica <- readOGR(dsn='/var/data/ohi/git-annex/Global/NCEAS-Regions_v2014/data', layer= 'Antarctica_clipped_polar_stereographic_v2')
plot(antarctica)
...
fig <-  ggplot(ccamlr_f, aes(long, lat, group = group)) +
  geom_polygon(aes_string(fill = goal)) +
