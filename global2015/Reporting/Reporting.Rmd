...
compare_wide <- spread(compare, goal, change_in_score)
...
cols <- data.frame(country=compare$country)
...
```{r, message=FALSE, warning=FALSE, error=FALSE, echo=FALSE, fig.width=12, fig.height=20,}
#-------------------------
#-------------------------
