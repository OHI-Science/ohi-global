...
### final commit from last year (v2023): e7497d6
### NOTE: scenario_year indicates the years that are being compared across last year nad this year. This will almost always be the previous year
### If the current year is used, there will be no data from last year to compare!!!

ohicore::score_check(
  
  file_name = "mar_sustainability_score", 
