...
ohicore::score_check(
  ...
  file_name = "fp_mpa_check", 
  
  commit = "previous", # change this back to "previous" next time
  scenario_year = 2024,
  scenario_name = "eez", 
...
```{r eval = FALSE}
compare <- read.csv(here("eez/score_check/hab_seaice_score_check_diff_data_2023-06-12.csv"))
