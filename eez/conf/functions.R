Setup = function(){
  if(file.exists(sprintf('%s/temp/reference_pts.csv', scenario))){file.remove(sprintf('%s/temp/reference_pts.csv', scenario))}
...
b <- b %>%
  ...
  write.csv(gap_fill_data, 'eez/temp/FIS_summary_gf.csv', row.names=FALSE)
