...
dateFile = '2018-11-27' #date extension on data files used for all tables/figures
...
colors <-   c(reds, blues)
#write.csv(data.frame(colors), here("global2018/Results/color_palette.csv"), row.names=FALSE)
