...
## See ohi-global/global2018/Reporting/Results.Rmd and ohi-global/global2018/first_look.Rmd for code used to create some of the figures included here
...
radicalFile = '2018-10-10' #date extension on the radical data files that are used for all tables/figures
...
A CSV formatted dataset from the 2018 assessment is [available](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/global2018/OHI_final_formatted_scores_2018-10-03.csv), right click on data and select "Save as...". These data include index and goal/subgoal scores (as well as the dimensions used to calculate scores: status, trend, pressure, resilience) for all 6 assessment years (2012-2017). See [README](https://rawgit.com/OHI-Science/ohi-global/draft/global2018/README.html) for description of data.
...
##### Figure A. Map and flowerplot of 2018 OHI index scores.
...
Index_map <- rasterGrob(readPNG("figures/maps_by_goal_mol/global_map_Index_2018_mol.png"), interpolate=TRUE)
...
AO_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_AO_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
BD_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_BD_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
CP_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_CP_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
CS_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_CS_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
CW_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_CW_%s_mol.png",scenario, scenario)), interpolate=TRUE)
...
FP_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_FP_%s_mol.png", scenario, scenario)), interpolate=TRUE)
FP_hist <- rasterGrob(readPNG(sprintf("figures/goal_histograms/FP_scores.png", scenario, scenario)), interpolate=TRUE)
FP_text <- textGrob("", gp=gpar(fontsize=14), vjust=-9.5)

LE_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_LE_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
NP_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_NP_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
SP_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_SP_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
TR_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_TR_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
bd <- textGrob("")
HAB_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_HAB_%s_mol.png", scenario, scenario)), interpolate=TRUE)
HAB_hist <- rasterGrob(readPNG("figures/goal_histograms/HAB_scores.png"), interpolate=TRUE)
SPP_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_SPP_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
fp <- textGrob("")
FIS_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_FIS_%s_mol.png", scenario, scenario)), interpolate=TRUE)
FIS_hist <- rasterGrob(readPNG("figures/goal_histograms/FIS_scores.png"), interpolate=TRUE)

MAR_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_MAR_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
sp <- textGrob("")
LSP_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_LSP_%s_mol.png", scenario, scenario)), interpolate=TRUE)
LSP_hist <- rasterGrob(readPNG("figures/goal_histograms/LSP_scores.png"), interpolate=TRUE)

ICO_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_ICO_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
le <- textGrob("")
LIV_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_LIV_%s_mol.png", scenario, scenario)), interpolate=TRUE)
LIV_hist <- rasterGrob(readPNG("figures/goal_histograms/LIV_scores.png"), interpolate=TRUE)

ECO_map <- rasterGrob(readPNG(sprintf("figures/maps_by_goal_mol/year_%s_nolegend/global_map_ECO_%s_mol.png", scenario, scenario)), interpolate=TRUE)
...
Overview of the scores from the 2018 assessment.  Each row represents a region, the main groupings represent goals, and within each goal there are 7 years of data.  Black regions indicate no data.  Download the [png version](https://github.com/OHI-Science/ohi-global/raw/draft/global2018/Reporting/figures/carpetPlot_2018.png) to zoom in to see specific regions.
...
Index_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_Index_%s_mol.png", scenario)), interpolate=TRUE)
map_label <- textGrob("", just=19, gp=gpar(fontsize=18))
...
AO_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_AO_%s_mol.png", scenario)), interpolate=TRUE)

BD_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_BD_%s_mol.png", scenario)), interpolate=TRUE)

CP_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_CP_%s_mol.png", scenario)), interpolate=TRUE)

CS_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_CS_%s_mol.png", scenario)), interpolate=TRUE)

CW_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_CW_%s_mol.png", scenario)), interpolate=TRUE)

FP_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_FP_%s_mol.png", scenario)), interpolate=TRUE)

LE_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_LE_%s_mol.png", scenario)), interpolate=TRUE)

NP_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_NP_%s_mol.png", scenario)), interpolate=TRUE)

SP_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_SP_%s_mol.png", scenario)), interpolate=TRUE)

TR_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_TR_%s_mol.png", scenario)), interpolate=TRUE)
...
BD <- textGrob("Biodiversity", gp=gpar(fontsize=12), just="left", x=0)
bd <- textGrob("")
HAB_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_HAB_%s_mol.png", scenario)), interpolate=TRUE)
SPP_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_SPP_%s_mol.png", scenario)), interpolate=TRUE)

FP <- textGrob("Food provision", gp=gpar(fontsize=12), just="left", x=0)
fp <- textGrob("")
FIS_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_FIS_%s_mol.png", scenario)), interpolate=TRUE)
MAR_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_MAR_%s_mol.png", scenario)), interpolate=TRUE)

SP <- textGrob("Sense of place", gp=gpar(fontsize=12), just="left", x=0)
sp <- textGrob("")
ICO_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_ICO_%s_mol.png", scenario)), interpolate=TRUE)
LSP_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_LSP_%s_mol.png", scenario)), interpolate=TRUE)

LE <- textGrob("Livelihoods and economies", gp=gpar(fontsize=12), just="left", x=0)
le <- textGrob("")
LIV_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_LIV_%s_mol.png", scenario)), interpolate=TRUE)
ECO_map <- rasterGrob(readPNG(sprintf("figures/map_trends/trends_map_ECO_%s_mol.png", scenario)), interpolate=TRUE)
