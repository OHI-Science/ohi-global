...
Penalties, $W$, based on level or US State Department travel warnings. When a warning applies to only a portion of the country, penalties are discounted by 0.5.
