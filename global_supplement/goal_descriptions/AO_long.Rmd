...
$$
D_{u} = (1 – PPPpcGDP) * (1 – O_{ao}), (Eq. 5.2)
$$
...
#### Trend
Trend was calculated as described in section  4.3.1. Because we only have one value for $O_{ao}$, the trend becomes the change over time in the PPPpcGDP, i.e., how ‘unmet demand’ is changing over time.
