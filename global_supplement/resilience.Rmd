...
res_matrix <- read.csv("../eez2016/conf/resilience_matrix.csv", na.strings="") 
...
$$
{ Y }_{ E }\quad =\quad \frac { \sum _{ i }^{ N }{ { w }_{ i }{ y_E}_{i} }  }{ \sum _{ i }^{ N }{ { w }_{ i }}}, (Eq. 4.11) 
$$
...
$$
y_{R, i}\quad =\quad \frac { \sum _{ i }^{ N }{ { w }_{ i }{ r }_{ i } }  }{ \sum _{ i }^{ N }{w_i} }, (Eq. 4.12) 
$$
...
Social integrity is intended to describe those processes internal to a community that affect its resilience. It is a function of a wide range of aspects of social structure. Social Integrity per goal for each region, $Y_{S}$, is therefore:
 ...
 $$
 Y_{ S}\quad =\quad \frac { \sum _{ i }^{ N }{ { y }_{ S,i } }  }{ N }, (Eq. 4.13)
 $$
