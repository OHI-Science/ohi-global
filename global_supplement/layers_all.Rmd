...
```{r, child = 'layers_info/hab_health.Rmd', echo=FALSE, results='asis'} 
...
```{r, child = 'layers_info/hab_trend.Rmd', echo=FALSE, results='asis'} 
...
```{r, child = 'layers_info/hab_extent.Rmd', echo=FALSE, results='asis'} 
