---
title: 'Ocean Health Index 2017: Methods'
...
**Figure 1.2. Flowerplot of goal scores for a region**
...
Map of the OHI regions (with color corresponding to 2017 regional index scores). Mollweide coordinate reference system is used because it accurately represents area.  

![](figures/global_map_Index_2017_mol.png)
...
ds_source <- read.csv("../eez_layers_meta_data/layers_eez_data_sources.csv") %>%
  ...
  select(Reference = ds_reference, "Description" = ds_description, Years=ds_years, Resolution = ds_native_resolution, Updated = ds_updated_2017)
kable(ds_source)
