...
For the
goals for which sensitivity ranks were assigned for
specific habitats or livelihood sectors (i.e., goal components), we
...
Overall ecological pressure (pE) acting on each goal and region is 
