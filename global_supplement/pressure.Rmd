...
![](figures/PressureComponentsPieChart.png)
...
pressure_matrix <- read.csv("../eez2016/conf/pressures_matrix.csv", na.strings=c("","NA"), stringsAsFactors = FALSE) %>%
...
$$
{ p }_{ i }\quad =\quad \frac { \sum _{ i }^{ N }{ { w }_{ i }{ s }_{ i } }  }{ 3 }, (Eq. 4.7)
$$
...
$$
{ p }_{ E }\quad =\quad \frac { \sum _{ i }^{ N }{ { (w }_{ i\_ max }*{ p }_{ i }) }  }{ \sum_{ i }^{ N } { { w }_{ i\_ max } }  },  (Eq. 4.8)
$$
...
$$
{ p }_{ S }\quad =\quad \frac { \sum _{ i }^{ N }{ z_{ i } }  }{ N }, (Eq. 4.9)
$$
