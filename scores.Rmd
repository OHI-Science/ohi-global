...
## read in scores
data <- readr::read_csv('https://github.com/OHI-Science/ohi-global/raw/published/yearly_results/global2019/OHI_final_formatted_scores_2019-11-15.csv') 
...
for (r in regions$region_id){ # r = regions$region_id[1]
  ...
  flower_path <- file.path(
    ...
    gsub("/home/frazier/ohi-global/", "", regions$flower_png[regions$region_id == r]))
