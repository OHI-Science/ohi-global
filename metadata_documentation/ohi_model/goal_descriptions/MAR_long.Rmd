...
where, $Y_{k}$ is the 4-year moving window average of tonnes of production [@unitednations2021a] for each ${k}$ mariculture species that is currently or at one time cultured within a country, and $S_{k,r}$ is the sustainability score for each $k$ mariculture species and region.
