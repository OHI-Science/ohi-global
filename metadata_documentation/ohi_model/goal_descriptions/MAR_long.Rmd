...
library(knitr)
library(kableExtra)
data <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2023/gh-pages/globalprep/mar/v2023/raw/species_list.csv') %>%
