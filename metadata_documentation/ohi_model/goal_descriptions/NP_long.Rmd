...
data <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2020/gh-pages/globalprep/np/v2021/int/h_methods_sum.csv') %>%
  group_by(product) %>%
...
data <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2020/gh-pages/globalprep/np/v2021/raw/commodities2products_new.csv') %>%
  group_by(product) %>%
...
data <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2020/gh-pages/globalprep/np/v2021/raw/commodities2products_weighting.csv') %>%
