...
For fish oil and fish meal, we used the same methods to calculate the status as our fisheries sub-goal, only we subsetted the species (those species can be seen in Table 5.10) to those species that contribute to fish oil and fish meal (methods for our fisheries sub-goal can be found in section 6.6.1). The tonnes of harvest of fish oil and fish meal species were also multiplied by 0.7 to reflect the amount of the fish actually going to production of feed or oil. 
...
The exposure term, $E_c$, is the ln-transformed intensity of harvest for ornamental fish calculated as tonnes of harvest per km2 of coral and rocky reef, relative to the global maximum. We ln transformed the harvest intensity scores because the distribution of values was highly skewed; because we do not know the true threshold of sustainable harvest, nearly all values would be considered highly sustainable without the log transformation. To estimate rocky reef extent area (km2) we used data from Halpern et al. (2008), which assumes rocky reef habitat exists in all cells within 1 km of shore. Coral extent area (km2) are derived from the 500m resolution dataset developed for Reefs at Risk Revisited (Burke et al. 2011).
