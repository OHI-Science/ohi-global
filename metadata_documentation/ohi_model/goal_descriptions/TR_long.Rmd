...
Ideally there would be data available specifically for arrivals, $A$, related to coastal tourism; however, the best data available at a global scale reports the total international arrivals, which does not solely reflect coastal tourism [@unwto2023arrivals]. Because we do not know how arrivals patterns vary geographically for each region, we attempt to help this value reflect coastal tourism by dividing by coastal area (representing capacity/space for coastal tourism) [@lewis2017largescale]. We further divide by total population as a proxy for ability to help tourists (ideally this would also be solely coastal, but again global datasets for this were not available) [@worldbank2023population; @ourworldindata2023population; @statista2023sabapopulation; @statista2023sinteustatiuspopulation; @statista2023bonairepopulation]. 
