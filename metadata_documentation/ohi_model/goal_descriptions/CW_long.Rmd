...
----------------- | ---------------------------------- |-------------------------
Eutrophication (nutrient) | FAO fertilizer and manure data [@united_nations_faostat_2021-1; @united_nations_faostat_2021; @halpern_cumulative_2021; @tuholske2021]| Standard method (section 5.3.1)
...
We used the modeled input of land-based nitrogen input from livestock manure and crop fertilizer application as a proxy for nutrient input using layer from @halpern_cumulative_2021 and @tuholske2021. The modeled proxy approach does not allow the distinction between toxic and non-toxic bloom events that can arise from excess nutrient input (often both referred to in the literature as harmful algal blooms, or HABs) or at what nutrient concentration an ecosystem is pushed into a HAB condition (i.e., the threshold value). Local studies may be able to obtain information on such non-linear responses and include it as part of this status measure.  
