...
Chemical | Land-based organic pollution (FAO pesticide data), Land-based inorganic pollution (based on run-off from impermeable surfaces), ocean-based pollution based on commercial shipping and port traffic [@united_nations_fao_2016; @halpern_global_2008] | Trend based only on changes in organic pollution, other variables remained the same
