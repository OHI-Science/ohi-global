...
#### Trend
The trend for this goal is calculated using different methods for each habitat due to data availability (Table 5.2, with sea ice shoreline following the same general methods as sea ice edge). 
