...
We estimated for four general manure pathways (managed then spread, spread on soil, spread on pasture, left on pasture) the proportion of excreted N that is removed by plants, volatilizes as NH3, is converted to NOx products during nitrification/denitrification, or, is lost through leaching or runoff (Fig. 7.2).
