...
The CP model is based on the relative health of the habitats that provide shoreline protection, weighted by their area and protectiveness rank (Halpern 2015). Condition of each habitat was calculated with various methods depending on data availability, which are mostly based on coverage area. Rank weights for the protective ability of each habitat (Rk) come from previous work that ranks mangroves, corals and sea ice as 4, salt marshes as 3, and seagrasses and kelp as 1 (higher values are better) (Halpern 2012). 
