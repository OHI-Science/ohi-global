...
A complete list of the data used in the calculations is [available](http://ohi-science.org/ohi-global/layers.html). You can also explore [OHI+ goal approaches](http://ohi-science.org/goals).
