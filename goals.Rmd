...
Scroll down to access metadata and data processing information, or explore [the complete list of global data](http://ohi-science.org/ohi-global/layers.html). You can also explore [OHI+ goal approaches](http://ohi-science.org/goals).
<!--- TODO: link to supplement --->

</div>
----

```{r, child=sprintf('%s/conf/web/goals.Rmd', dir_scenario)}
```
