...
where $E_{d}$ is defined as the proportion of employees directly involved in the travel and tourism industry ($E_{t}$) relative to the total employees in that region, calculated as the country’s total labor force ($L_{t}$) corrected by the percent of the population that is unemployed ($U_{t}$), such that:
