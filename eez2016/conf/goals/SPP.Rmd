...
The Species model measures the average number of threatened species in each country, weighted by each species' threat status defined by IUCN Red List and its coverage area. The spatial resolution is 0.5 degree. 
