...
- [B/Bmsy estimates obtained using RAM data (when available) and the catch-MSY method] (go to the layers.html#ao_need, where there's more description,  whether it was updated in that year, relevant refs, link to data prep) (some day, info about gapfilling)
The ratio of fish population abundance compared to the abundance required to deliver maximum sustainable yield	
- []
