...
* [`r sprintf('radicalv2_eez%s_*date*.csv', scenario)`](`r sprintf('https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/%s/radicalv2_eez2016_%s.csv', saveFile, radicalFile)`). This file includes only the 2016 data, and is used in the Data Explorer.
