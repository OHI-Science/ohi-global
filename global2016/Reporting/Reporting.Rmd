...
# sp <- read.csv(sprintf('../radical_with_region_names_%s.csv', radicalFile)) %>%
#   filter(region_name %in% c("North Korea", "Saint Helena", "Qatar", "Line Islands (Kiribati)",
#                             "Sudan", "Syria", "Yemen", "Eritrea", "Tokelau", "Bahrain", "Jordan",
#                             "Iraq", "Bouvet Island")) %>%
#   filter(dimension == "score") %>%
#   filter(goal %in% c("SP", "LSP", "ICO")) %>%
#   spread(goal, value) %>%
