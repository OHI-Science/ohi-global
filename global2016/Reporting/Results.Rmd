...
plot(p)   
ggsave("figures/trend vs score.png", width=6, height=4)
...
tmp <- filter(index_2012, index_delta<=(-7) & index_delta>=(-8))  
  ...
  p <- ggplot2::ggplot(index_2012, aes(x=index_delta, y=rank_delta)) +
    ...
    geom_point(data = filter(index_2012, index_delta>0 & rank_delta<0), shape=19, size=1.75, color="red") +
    geom_point(data = filter(index_2012, index_delta<0 & rank_delta>0), shape=19, size=1.75, color="blue")  +
...
print(g)
 ...
 ggsave("figures/trend_histogram_color.png", width=4, height=3)
...
print(g)
 ...
 ggsave("figures/score_histogram_color.png", width=4, height=3)
...
ggsave("figures/nlme_trend_results.png", width=6, height=4)
