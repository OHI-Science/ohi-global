...
## Running:
 ...
 # 2. Make sure that all the files in eez_layers_meta_data have been updated (e.g., layers_eez_base, layers_eez_targets, layers_eez_methods, layers_eez_datasources)
