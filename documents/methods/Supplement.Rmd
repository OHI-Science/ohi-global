---
title: 'Ocean Health Index 2021: Methods'
...
There are 220 global coastal countries and territorial regions (Table 4.1). Regions are based on Exclusive Economic Zone boundaries [EEZ, @claus2012marine].  However, we aggregate some EEZ regions to the level of country (e.g., Hawaii is estimated as part of the larger U.S.). We have also modified some boundaries [@halpern2012index; @halpern2015patterns]. We do not estimate OHI values for disputed or unclaimed areas.

**Figure 4.1. Global regions**
Map of the OHI regions (with color corresponding to 2021 regional index scores). Mollweide coordinate reference system is used because it accurately represents area.  

![](../../yearly_results/global2021/Results/figures/maps_by_goal_mol/global_map_Index_2021_mol.png)
