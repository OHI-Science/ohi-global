...
url <- read.csv(here("metadata_documentation/layers_eez_dataprep.csv")) %>%
  ...
  mutate(count = sum(N)) %>%
  mutate(url_link = ifelse(count==1,  sprintf("[data prep](https://htmlpreview.github.io/?https://github.com/ohi-science/ohiprep_v%s/gh-pages/%s)", assessmentYear, dataprep_url), 
